...
{
	//push colors to hold
	pointColors.push_back(glm::vec3(1.0f, 0.0f, 0.0f));
	//vertex 2
	pointColors.push_back(glm::vec3(0.0f, 1.0f, 0.0f));
	//vertex 3
	pointColors.push_back(glm::vec3(0.0f, 0.0f, 1.0f));
...
void AppClass::InitVariables(void)
{
	...
	lVertex.push_back(pointColors[0]); //color
	//vertex 2
	lVertex.push_back(glm::vec3(1.0f, -1.0f, 0.0f)); //position
	lVertex.push_back(pointColors[1]); //color
	//vertex 3
	lVertex.push_back(glm::vec3(0.0f, 1.0f, 0.0f)); //position
	lVertex.push_back(pointColors[2]); //color
...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	{
		pointColors[0] = glm::vec3(1.0f - pointColors[0].r, 1.0f - pointColors[0].g, 1.0f - pointColors[0].b);
		pointColors[1] = glm::vec3(1.0f - pointColors[1].r, 1.0f - pointColors[1].g, 1.0f - pointColors[1].b);
		pointColors[2] = glm::vec3(1.0f - pointColors[2].r, 1.0f - pointColors[2].g, 1.0f - pointColors[2].b);
		std::vector<glm::vec3> lVertex;
		//vertex 1
		lVertex.push_back(glm::vec3(-1.0f, -1.0f, 0.0f)); //position
		lVertex.push_back(pointColors[0]); //color
