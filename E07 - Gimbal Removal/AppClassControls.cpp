...
#pragma endregion
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
	{
		if (fMultiplier)
		{
			quaternion rotationQuat = glm::angleAxis(glm::radians(1.0f), vector3(-1.0f, 0.0f, 0.0f));
			m_qOrientation = m_qOrientation * rotationQuat;
		}
		else
		{
			quaternion rotationQuat = glm::angleAxis(glm::radians(1.0f), vector3(1.0f, 0.0f, 0.0f));
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		if (fMultiplier)
		{
			quaternion rotationQuat = glm::angleAxis(glm::radians(1.0f), vector3(0.0f, -1.0f, 0.0f));
			m_qOrientation = m_qOrientation * rotationQuat;
		}
		else
		{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		if (fMultiplier)
		{
			quaternion rotationQuat = glm::angleAxis(glm::radians(1.0f), vector3(0.0f, 0.0f, -1.0f));
			m_qOrientation = m_qOrientation * rotationQuat;
		}
		else
		{
