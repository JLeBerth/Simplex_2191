...
void AppClass::InitShaders(void)
{
	...
	c_uShaderProgramID = LoadShaders("Shaders//ComplementaryColor.vs", "Shaders//ComplementaryColor.fs");
...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num4))
	{
		...
		if (isComplementary)
		{
			glUseProgram(c_uShaderProgramID);
		}
		else
		{
			glUseProgram(m_uShaderProgramID);
...
void AppClass::Release()
{
	...
	glDeleteShader(c_uShaderProgramID);
